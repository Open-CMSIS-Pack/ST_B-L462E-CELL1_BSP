...
|:--------------|:---------------|:---------------------|:------
| vioBUTTON0    | vioSignalIn.0  | USER button (B2)     | PC13
| vioLED0       | vioSignalOut.0 | LED green   (LD1)    | PC6
| vioLED1       | vioSignalOut.1 | LED red     (LD2)    | PB15
| vioLED2       | vioSignalOut.2 | LED blue    (LD3)    | PB14
*/
